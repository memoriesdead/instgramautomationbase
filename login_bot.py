...
def login(properties,driver):
    ...
    sleep(3)
    driver.find_element(By.XPATH, "/html/body/div[2]/div/div/div/div[2]/button[1]").click()

    driver.find_element(By.XPATH, "/html/body/div[1]/section/main/article/div[2]/div[1]/div/form/div/div[1]/div/label/input").send_keys(email)
